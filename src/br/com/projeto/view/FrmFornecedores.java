...
public class FrmFornecedores extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jTabbedPane4.addTab("Dados da Empresa", painel_dados_pessoais);
        ...
        jTabbedPane4.addTab("Consulta de Fornecedores", painel_consulta_clientes);
    ...
    private void tabelaFornecedoresMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tabelaFornecedoresMouseClicked
        ...
        txtestado.setSelectedItem(tabelaFornecedores.getValueAt(tabelaFornecedores.getSelectedRow(), 12).toString());
